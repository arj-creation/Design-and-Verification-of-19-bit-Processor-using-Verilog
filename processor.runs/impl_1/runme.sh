...
HD_PWD='C:/Users/arjun/Documents/project/processor3/processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_Cycle_Top.tcl -notrace
